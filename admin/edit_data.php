            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Tempat UMKM</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            include '../koneksi.php';
                            $id = $_GET['id_umkm'];
                            $query = mysqli_query($koneksi, "select * from umkm where id_umkm='$id'");
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">ID UMKM</label>
                                        <div class="col-sm-8">
                                            <input name="id_umkm" type="text" id="id_umkm" class="form-control" value="<?php echo $data['id_umkm']; ?>" readonly />
                                            <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Nama UMKM</label>
                                        <div class="col-sm-8">
                                            <input name="nama_umkm" type="text" id="nama_umkm" class="form-control" value="<?php echo $data['nama_umkm']; ?>" required />
                                        </div>
                                    </div>
