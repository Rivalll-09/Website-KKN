			...
			<footer class="footer-area section-gap">
				<div class="container">
					...
					<div class="row footer-bottom d-flex justify-content-between align-items-center">
						...
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved || KKN Universitas Negeri Medan</i></a>
</p>
						<div class="col-lg-4 col-sm-12 footer-social">
							<a href="https://www.instagram.com/kkn_unimed_marendal1/"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
				</div>
			</footer>
